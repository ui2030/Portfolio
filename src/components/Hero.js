      ...
      <header className="fixed bg-base-300 shadow-2xl shadow-neutral inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <p className="-m-1.5 p-1.5 font-semibold">Kim Cheonui</p>
          </div>
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                    I build AI that solves real problems — designing, training, and deploying machine learning and LLM systems that create real-world impact.
                  </p>
                </div>
